...
AS $$
DECLARE
  project_url TEXT := 'https://smamtwdjxecuelzdyqck.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNtYW10d2RqeGVjdWVsemR5cWNrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMzIwMjk4OSwiZXhwIjoyMDI4Nzc4OTg5fQ.mNC9UxySkeSkD8jny9ISnkIMeirZbrdwZHqUTeYEZMU'; -- full access needed for http request to storage
